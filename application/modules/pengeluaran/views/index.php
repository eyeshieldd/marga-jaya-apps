<div class="block">
    ...
    <div class="row ">
            <div class="col-xs-12 col-md-12"><a class="btn btn-alt-secondary btn-lg mb-10" href="<?= base_url('dashboard') ?>">Back</a>
            <a class="btn btn-primary btn-lg mb-10 pull-right" href="<?= base_url('pengeluaran/tambah') ?>">  <i class="fa fa-plus"></i> Tambah</a></div>
        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <input type="text" name="pengeluaran" class="form-control form-control-lg">
                            </div>                            
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <label>Cabang</label>
        ...
        <div class="table-responsive">
            <table class="display nowrap table table-hover table-striped table-bordered dataTable" width="100%" id="tpengeluaran">
                <thead>
                    <tr>
