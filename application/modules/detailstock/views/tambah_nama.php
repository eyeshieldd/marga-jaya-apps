		            ...
		            <div class="block-content">
		                <form action="" method="" enctype="multipart/form-data">
		                    <div class="form-group row">
		                        <label class="col-lg-2 col-xs-12 col-md-12" for="nama_detailstock">Nama Anda</label>
		                        <div class="col-lg-10 col-xs-12 col-md-12">
		                            <input type="text" class="form-control form-control-lg" id="nama_detailstock" name="nama_detailstock" placeholder="Input data nama anda..">
		                        </div>
		                    </div>
		                </form>
		            </div>
