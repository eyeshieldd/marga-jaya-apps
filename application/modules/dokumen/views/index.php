<div class="block">
    ...
    <div class="block-content block-content-full">
        <div class="row ">
            ...
            <a class="btn btn-primary btn-lg mb-10 pull-right" href="<?= base_url('dokumen/tambah') ?>">  <i class="fa fa-plus"></i> Tambah</a></div>
        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6 col-xs-12">
                                <label>Dokumen</label>
                                <input type="text" name="dokumen" class="form-control form-control-lg">
                            </div>
                            <!-- <div class="col-sm-6 col-xs-12">
                                <label>Cabang</label>
        ...
        <div class="table-responsive">
            <table class="display nowrap table table-hover table-striped table-bordered dataTable" width="100%" id="tdokumen">
                <thead>
                    <tr>
