...
<html lang="en" class="no-focus">
    <head>
        ...
        <meta name="description" content="Marga Jaya App">
        <meta name="author" content="pixelcave">
        <meta name="robots" content="noindex, nofollow">

        <!-- Open Graph Meta -->
        <meta property="og:title" content="">
        <meta property="og:site_name" content="Marga Jaya">
  ...
  vertical-align:text-bottom;" src="https://marga-jaya.com/images/logo@2x.png" />
                                                        </a>
                                </div>
                                        ...
                                        <div class="block-content">
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    ...
                                                    <input class="form-control" placeholder="Username" id="txt-username" name="username" required="" type="text">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12">
