...
class M_auth extends CI_Model {
    ...
    function get_detail_data_login($params) {
        $sql = "SELECT su.user_id, su.username, su.nama_lengkap, su.telepon, su.email, su.jenis_kelamin, su.foto, c.cabang_id, c.nama_cabang, su.`status` , sug.* 
                FROM sys_user su
                LEFT JOIN (
                ...
                LEFT JOIN cabang c USING(cabang_id)
                WHERE su.user_id = ?";
